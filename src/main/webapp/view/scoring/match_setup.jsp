                        ...
                        <div
                            ...
                            <%-- 1. GAME MODE SELECTION --%>
                                <div class="border-b-4 border-black pb-6">
                                    <label
                                        class="text-xs font-black uppercase tracking-widest opacity-50 block mb-2">Scoring
                                ...
                                <%-- 3. TEAM ALLOCATION & SHUFFLE (BAGIAN BAWAH) --%>
                                    <div class="border-4 border-black rounded-3xl p-6 bg-gray-50 space-y-6">
                                        ...
                                        <form id="matchForm"
                                            action="${pageContext.request.contextPath}/view/scoring/score.jsp"
                                            ...
                                            <div class="p-4 border-2 border-black bg-cyan-50/50 rounded-2xl space-y-4">
                                                ...
                                                <div>
                                                    <label
                                                        class="text-[9px] font-bold uppercase opacity-50 block mb-1">Player
                                                        A</label>
